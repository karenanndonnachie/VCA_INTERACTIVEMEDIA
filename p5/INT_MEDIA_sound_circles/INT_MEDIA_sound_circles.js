  ...
  if (started==true) {
    if (millis() - timerStart > timerLength) {
      ...
      if (a>=TWO_PI) { // close shape by drawing to vect. 'first point'
        rotate();
        line(firstTreb.x, firstTreb.y, prevTreb.x, prevTreb.y)
      } // correct to Treb not Mid
      //endShape(CLOSE);
      ...
      if (a>=TWO_PI) { // close shape by drawing to vect. 'first point'
        rotate();
        line(firstMid.x, firstMid.y, prevMid.x, prevMid.y)
      } // correct to Treb not Mid
      //endShape(CLOSE);
      ...
      if (a>=TWO_PI) { // close shape by drawing to vect. 'first point'
        rotate();
        line(firstBass.x, firstBass.y, prevBass.x, prevBass.y)
      } // correct to Treb not Mid
      //endShape(CLOSE);
